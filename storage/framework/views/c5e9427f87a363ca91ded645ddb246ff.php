                ...
                <form action="<?php echo e(route('testimonials.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-7 mb-5">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Ex: John Doe" value="<?php echo e(old('name')); ?>" required>
                        </div>

                        <div class="col-md-6 mb-4">
                            <label class="form-label">Designation</label>
                            <input type="text" name="designation" class="form-control" placeholder="Ex: Software Engineer" value="<?php echo e(old('designation')); ?>">
                        </div>
                    </div>

                    <div class="mb-4">
                        <label class="form-label">Review Comment</label>
                        <textarea name="comment" class="form-control" rows="4" placeholder="Type the customer's feedback..." required><?php echo e(old('comment')); ?></textarea>
                    </div>
                    ...
                    <div class="mt-4 border-top pt-4 d-flex justify-content-between align-items-center">
                        <a href="<?php echo e(route('testimonials.index')); ?>" class="text-decoration-none text-secondary fw-bold">
...
<?php echo $__env->make('admin.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ecommerce_pro\resources\views/admin/testimonials/create.blade.php ENDPATH**/ ?>