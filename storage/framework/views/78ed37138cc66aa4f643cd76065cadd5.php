<ul class="sidebar-menu">
                ...
                <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-briefcase"></i><span> Category</span><i class="icon-arrow-down"></i></a>
                      <ul class="treeview-menu">
                        <li><a class="waves-effect waves-dark" href="<?php echo e(route('admin.category.create')); ?>"><i class="icon-arrow-right"></i>Add category</a></li>
                         <li>
                ...
                <i class="icon-arrow-right"></i> Manage Category
                 ...
                 <li class="treeview"><a class="waves-effect waves-dark" href="#!">
                    ...
                    <i class="icon-arrow-down"></i></a>
                      <ul class="treeview-menu">
<li><a class="waves-effect waves-dark" href="<?php echo e(route('admin.subcategory.create')); ?>">
    <i class="icon-arrow-right"></i>Add Sub-category</a></li>
                         <li>
            <a href="<?php echo e(route('admin.subcategory.manage')); ?>">
         ...
         <li class="treeview"><a class="waves-effect waves-dark" href="#!">
                    ...
                    <i class="icon-arrow-down"></i></a>
                      <ul class="treeview-menu">
<li><a class="waves-effect waves-dark" href="<?php echo e(route('admin.product.create')); ?>">
