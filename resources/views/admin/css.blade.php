<title>Quantum Able Bootstrap 4 Admin Dashboard Template</title>
   ...
   <!-- Required Fremwork -->
   <link rel="stylesheet" type="text/css" href="{{asset('admin/plugins/bootstrap/css/bootstrap.min.css')}}">

   <!-- Chartlist chart css -->
   <link rel="stylesheet" href="{{asset('admin/plugins/chartist/dist/chartist.css')}}" type="text/css" media="all">

   <!-- Weather css -->
   <link href="{{asset('admin/css/svg-weather.css')}}" rel="stylesheet">
