  <div class="container-fluid">
            ...
            <div class="row">
               <div class="col-lg-4">
                  <div class="card">
                     <div class="user-block-2">
                        <img class="img-fluid" src="{{asset('admin/images/widget/user-1.png')}}" alt="user-header">
               ...
               <div class="col-xl-4 col-lg-12 grid-item">
                  <div class="card">
                     <div class="card-block horizontal-card-img d-flex">
                        <img class="media-object img-circle" src="{{asset('admin/images/lockscreen.png')}}" alt="Generic placeholder image">
                        <div class="d-inlineblock  p-l-20">
                          <h6>Josephin Doe</h6>
                          <a href="#">contact@admin.com</a>
                       </div>
                        ...
                        <div class="table-responsive">
                           <table class="table m-b-0 photo-table">
                              ...
                              <tbody>
                                 <tr>
                                    <th>
                                       <img class="img-fluid img-circle" src="{{asset('admin/images/avatar-2.png')}}" alt="User">
                                    </th>
                                    <td>Appestia Project
                                 ...
                                 <tr>
                                    <th>
                                       <img class="img-fluid img-circle" src="{{asset('admin/images/avatar-1.png')}}" alt="User">
                                    </th>
                                 ...
                                 <tr>
                                    <th>
                                       <img class="img-fluid img-circle" src="{{asset('admin/images/avatar-3.png')}}" alt="User">
                                    </th>
                                    <td>Contract with belife Company
                                       <p><i class="icofont icofont-clock-time"></i>Created 20.10.2016</p>
                                    </td>
