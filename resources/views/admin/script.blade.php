 <script src="{{asset('admin/plugins/Jquery/dist/jquery.min.js')}}"></script>
   ...
   <script src="{{asset('admin/plugins/jquery.nicescroll/jquery.nicescroll.min.js')}}"></script>

   <!--classic JS-->
   <script src="{{asset('admin/plugins/classie/classie.js')}}"></script>

   <!-- notification -->
   <script src="{{asset('admin/plugins/notification/js/bootstrap-growl.min.js')}}"></script>

   <!-- Sparkline charts -->
   <script src="{{asset('admin/plugins/jquery-sparkline/dist/jquery.sparkline.js')}}"></script>
   ...
   <script src="{{asset('admin/js/menu.min.js')}}"></script>
<script>
var $window = $(window);
